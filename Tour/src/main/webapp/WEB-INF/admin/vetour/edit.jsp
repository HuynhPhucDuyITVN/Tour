	                ...
	                <div class="container">
				        <div style="width: 400px" class="card mx-auto">
				        	<div class="card-header">
				        		<h3 class="text-center font-weight-light my-4">Chi tiết tour</h3>
				        	</div>
				            <div class="card-body">
				            	<div class="white-box text-center">
		                            <img class="img-thumbnail" style="height:300px" src='./img/<s:property value="vetour.hinhanh"/>' />
		                        </div>
		                        <br/>
		                        <s:form action="updateVeTourAction" method="POST" enctype="multipart/form-data" validate="true">
									...
									<s:textfield class="form-control"  label="Tên tour" id="tentour" name="tentour" value="%{vetour.tentour}"  />
									<s:textfield class="form-control"  label="Mô tả" id="mota" name="mota" value="%{vetour.mota}"  />
									<s:textfield class="form-control"  label="Thời gian" id="thoigian" name="thoigian" value="%{vetour.thoigian}"  />		
									<s:file class="form-control"  name="hinh" label="Chọn hình" accept="image/png, image/jpeg, image/gif"></s:file>
									<s:textfield class="form-control" label="Giá" id="gia" name="gia" value="%{vetour.gia}"  />
