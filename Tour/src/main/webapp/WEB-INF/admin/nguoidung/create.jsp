				        ...
				        <div class="row">
				            ...
				            <div class="col-md-4">
				                <div class="p-3 shadow">
				                    <h3 class="text-info text-center">Thêm tài khoản</h3>
				                    <s:form action="storeNguoiDungAction" method="POST" validate="true">
				                    	<div class="my-3">
				                            <label>Tên đăng nhập</label>
				                            <input class="form-control" required="required" id="tendangnhap" name="tendangnhap" />
				                        </div>
				                        <div class="my-3">
				                            <label>Mật khẩu</label>
				                            <input class="form-control" type="password" required="required" id="matkhau" name="matkhau"  />
				                        </div>
