...
<html lang="en">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <p>
                <a class="btn btn-outline-info" href="createNguoiDungAction">Thêm mới</a>
            </p>
        </div>
        <div class="card-body">
            <table id="datatablesSimple">
                ...
                <tbody>
					...
					<tr>
						...
						<td><a class="btn btn-outline-warning" href='editNguoiDungAction?id=<s:property value="id"/>'>Chỉnh sửa</a>
						<a class="btn btn-outline-danger" href='changeNguoiDungAction?id=<s:property value="id"/>'>Đổi mật khẩu</a></td>
					</tr>
					</s:iterator>
                </tbody>
            </table>
