					        ...
					        <div class="row">
					            ...
					            <div class="col-md-4">
					                <div class="p-3 shadow">
					                    <h3 class="text-info text-center">ĐỔI MẬT KHẨU</h3>
					                    <s:form Style="align-items: center;" action="passNguoiDungAction" method="Post" validate ="true">
					                    	...
					                    	<div class="my-3">
					                            ...
					                            <input required="required"  type="password" id="matkhaucu" name="matkhaucu" class="form-control"  />
					                        </div>
					                        <div class="my-3">
					                        ...
					                        <div class="my-3">
					                            ...
					                            <input required="required" type="password" id="xacnhan" name="xacnhan" class="form-control"  />
					                        </div>
					                        <div class="d-grid">
					                        	<s:submit value="Đổi" class="btn btn-info btn btn-block"/>
					                        </div>
					                    </s:form>
					                    <div class="my-3">
					                    </div>
