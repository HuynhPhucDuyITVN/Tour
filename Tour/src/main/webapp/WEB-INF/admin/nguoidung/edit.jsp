	                ...
	                <div class="container">
				        <div style="width: 400px" class="card mx-auto">
				        	<div class="card-header">
				        		<h3 class="text-center font-weight-light my-4">Chi tiết tài khoản</h3>
				        	</div>
				            <div class="card-body">
		                        <s:form action="updateNguoiDungAction" method="POST" validate="true">
									...
									<s:textfield readonly="true" class="form-control"  label="Tên tài khoản" id="tendangnhap" name="tendangnhap" value="%{nguoidung.tendangnhap}"  />
									<select class="form-control"  name="loaiquyen" id="loaiquyen">
