...
<html lang="en">
    ...
    <h1 class="mt-4">Danh sách vé đặt</h1>
                ...
                <tbody>
                    <s:iterator var="datve" value="datvelist">
                        <tr>
							...
							<td><img class="img-thumbnail" style="width:50px" src=' ./img/<s:property value="hinhanh"/>'/></td>
							<td><s:property value="sdt"/></td>
							<td><s:property value="soluong"/></td>
							<td><s:property value="getText('{0,number,#,##0}',{gia})"/></td>
							<td><s:property value="getText('{0,number,#,##0}',{thanhtien})"/></td>
							...
							<td><a  class="btn btn-outline-warning" href='editDatVeAction?id=<s:property value="id"/>'>Chỉnh sửa</a></td>
                        </tr>
                    </s:iterator>
                </tbody>
            </table>
