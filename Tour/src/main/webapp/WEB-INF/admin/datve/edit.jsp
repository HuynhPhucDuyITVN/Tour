    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
	                <div class="container">
			        <div style="width: 400px" class="card mx-auto">
			        	<div class="card-header">
			        		<h3 class="text-center font-weight-light my-4">Chỉnh sửa vé đặt</h3>
			        	</div>
			            <div class="card-body">
			            	<div class="white-box text-center">
	                            <img class="img-thumbnail" style="height:300px" src=' ./img/<s:property value="datve.hinhanh"/>' />
	                        </div>
	                        <br/>
			            	<s:form action="updateDatVeAction" method="POST" validate="true">
				                <input type="hidden" name="id" value='<s:property value="datve.id"/>'/>
				                <s:textfield class="form-control" readonly="true"  label="Tên tài khoản" id="tendangnhap" name="tendangnhap" value="%{datve.tendangnhap}"  />
								<s:textfield class="form-control" readonly="true" label="Tour" id="tentour" name="tentour" value="%{datve.tentour}"  />
								<s:textfield class="form-control" readonly="true" label="Số điện thoại" id="sdt" name="sdt" value="%{datve.sdt}"  />
								<s:textfield class="form-control" readonly="true" label="Số lượng" id="soluong" name="soluong" value="%{datve.soluong}"  />
								<s:textfield class="form-control" readonly="true" label="Giá" id="gia" name="gia" value="%{datve.gia}"  />
								<s:textfield class="form-control" readonly="true" label="Thành tiền" id="thanhtien" name="thanhtien" value="%{datve.thanhtien}"  />
							...
							<s:submit value="Cập nhật" class="btn btn-info btn btn-block"/>
							</s:form>
			            </div>
			        </div>
			    </div>
