	                ...
	                <div class="container">
				        <div style="width: 400px" class="card mx-auto">
				        	<div class="card-header">
				        		<h3 class="text-center font-weight-light my-4">Chi tiết loại tour</h3>
				        	</div>
				            <div class="card-body">
				            	<div class="white-box text-center">
		                            <img class="img-thumbnail" style="height:300px" src='./img/<s:property value="loaitour.hinhanh"/>' />
		                        </div>
		                        <br/>
		                        <s:form action="updateLoaiTourAction" method="POST" enctype="multipart/form-data" validate="true">
									...
									<s:textfield class="form-control" label="Tên loại tour" id="tenloaitour" name="tenloaitour" value="%{loaitour.tenloaitour}"  />
