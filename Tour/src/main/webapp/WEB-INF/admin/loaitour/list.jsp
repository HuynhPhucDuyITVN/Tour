...
<html lang="en">
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <p>
                <a class="btn btn-outline-info" href="createLoaiTourAction">Thêm mới</a>
            </p>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    <s:iterator var="loaitour" value="loaitourlist">
						<tr>
							...
							<td><a  class="btn btn-outline-warning" href='editLoaiTourAction?id=<s:property value="id"/>'>Chỉnh sửa</a></td>
						</tr>
					</s:iterator>
                </tbody>
            </table>
