	...
	<div class="pt-5">
		...
		<div class="container">
			<div class="row justify-content-center text-center mb-5">
				<div class="col-lg-6">
					<h2 class="section-title text-center mb-3">Danh sách Tour</h2>
				</div>
			</div>
			<div style="row-gap: 15px;" class="row">
			<s:iterator var="vetour" value="vetourlist">
				<div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
					<div style="width: 250px;" class="media-1">
						<a style="width: 250px; height: 250px" href='DetailKhachAction?idvetour=<s:property value="id"/>' class="media-thumb">
						...
						<div class="d-flex align-items-center">
							<div>
								<h3  style="width: 250px; overflow: hidden; text-overflow: ellipsis; line-height: 30px; -webkit-line-clamp: 1; display: -webkit-box; -webkit-box-orient: vertical; ">
